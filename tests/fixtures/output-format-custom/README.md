---
mission: Output format test (custom)
...
# Output Format Test (Custom)

A minimal workflow for testing that the first officer follows custom output format instructions.
...
When exiting single-entity mode, format the output as follows:
...
Print exactly these three lines using the entity's frontmatter values. Do not include the stage report body or any other content.
