---
mission: Spike termination test (gated)
...
# Spike Termination Test (Gated)

A minimal gated workflow for testing session termination behavior in `claude -p` mode.
...
The task is actively being worked on. Has a gate — requires approval before advancing.
