---
mission: Output format test (default)
...
# Output Format Test (Default)

A minimal workflow for testing that the first officer uses default output format when no Output Format section is present.
